    ...
    internal class Program
    {
        ...
        static int BinarySearch(int[] array, int elementToSearch)
        {
            ...
            while (lower <= upper)
            {
                ...
                else if (array[(lower + upper) / 2] == elementToSearch)
                {
        ...
        static int BinarySearchRecursive(int[] array, int elementToSearch, int lower, int upper)
        {
            if (array[(lower + upper) / 2] > elementToSearch)   
            {
                BinarySearchRecursive(array, elementToSearch, lower, (lower + upper) / 2);
            }
            else if (array[(lower + upper) / 2] == elementToSearch)
            {
                return (lower + upper) / 2;
            ...
            {
                BinarySearchRecursive(array, elementToSearch, (lower + upper) / 2, upper);
            }
